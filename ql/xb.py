...
def filter_list(tr):
    ...
    highBlackList = [
        ...
        "需要邀请", "特邀", "受邀", "助力",
        "首单", "盲盒", "月黑风高", "生日礼", "互换",
        "件", "/袋", "/盒", "箱", "限量", "如有", "折合", "到手", "进口", "买家", "小法庭", "单号",
        # "返",
        "求", "啥", "咋", "呢", "请问", "问一下", "请教", "怎么", "怎样", "咨询", "居然要", "都多少", "是多少", "怀疑",
        "吧？", "了？", "链接？", "么？", "呀!", "啊？",
        "黄了", "没了", "果熟", "有果", "油果", "18cm", "续费", "拦截", "删了", "不玩了",
        "被盗", "崩溃", "客服",
        "风险", "美元", "提额", "保险", "开通", "境外",
        "迅雷", "唯品会小程序", "电子书", "监控", "查询",
        "漏水", "洗发水", "纯水", "碱水", "水果", "水雾", "酒水", "吸水", "精萃水", "净水器", "补水",
    ]
    lowBlackList = [
        "多拍", "返红包", "券包", "直播间下单", "试用", "什么划算", "点秒杀", "前10", "以旧换新",
        "洗衣液", "內衣", "火锅", "拖鞋", "椅", "香菇", "婴儿", "烧烤", "洁面", "购物袋",
        "茅台", "京造", "京东买药", "巧乐兹", "第三方", "东方甄选", "馋嘴", "屈臣氏", "采销", "珀莱雅",
        "华为", "HUAWEI", "MiPay", "yzf",
        "火车票", "电影", "门票", "单车", "流量", "出行优惠券", "网盘",
