...
def filter_list(tr):
    ...
    highBlackList = [
        ...
        # "凑",
        # ----语气----
        "问题", "问问", "问下", "谢谢", "请问", "问一下", "请教", "求", "咋", "怎么", "怎样", "咨询",
        "啥", "呢", "居然要", "都多少", "是多少", "是不是快", "便宜啊",
        "吧？", "了？", "链接？", "么？", "呀!", "啊？", "啦 ！", "了啊",
        # ----负面----
    ...
    lowBlackList = [
        "多拍", "返红包", "券包", "免单", "预售", "试用", "什么划算", "点秒杀", "前10", "以旧换新", "防身",
        "小程序下单", "直播间下单",
        # ----实物----
        "火锅", "香菇", "烧烤", "麻辣烫", "杯", "馋嘴", "卤", "梨",
        ...
        # ----虚拟----
        "华为", "HUAWEI", "MiPay", "yzf",
        "火车", "电影", "门票", "打车", "单车", "流量", "出行优惠券", "网盘", "地铁", "网易云",
        # ----卡----
    ...
    whiteList = [
        ...
        "支付宝", "zfb", "转账", "网商", "某付宝",
        "微信", "wx", "vx", "v.x", "V.x", "小程序", "立减金", "公众号", "原文",
        "京东", "狗东", "JD", "京豆", "e卡",
        "抖音", "dy",
        "美团", "饿了么", "elm",
        "红包", "抽奖", "秒到", "保底", "游戏", "下载",
