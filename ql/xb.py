...
def filter_list(tr):
    ...
    commonBlackList = [
        "定位", "部分", "山东", "福建", "江苏", "云南", "江西", "河北", "广东", "重庆", "吉林", "湖北", "河南",
        "陕西", "湖南", "安徽", "四川", "北京", "天津", "宁夏", "广西", "辽宁",
        "厦门", "东北", "南京", "东莞", "广州", "辽宁", "南海", "苏州", "中山", "常州", "青岛", "成都",
        # ----卡----
        "平安x", "中行x", "邮储x", "农行x", "交行x", "光大x", "阳光惠生活", "平安银行X", "平安银行信",
        "邮储联名", "邮储美团联名", "闪光卡", "广发", "恒丰", "浦大喜奔", "缤纷生活", "万事达", "汇丰",
    ]
    highBlackList = [
        "【顶】",
        # ----玩法----
        ...
        "啥", "呢", "居然要", "都多少", "是多少", "是不是", "便宜啊", "麻烦", "帮忙看", "能不能",
        "吧？", "了？", "链接？", "么？", "呀!", "啊？", "啦 ！", "了啊",
        # ----负面----
    ...
    lowBlackList = [
        ...
        "洗衣", "內衣", "拖鞋", "椅", "洁面", "购物袋", "佛", "纸", "清风", "蛋白",
        "机油", "猫粮", "婴儿", "小孩", "无线",
        # ----品牌----
        "茅台", "五粮液", "习酒", "窖", "京造", "京东买药", "屈臣氏", "珀莱雅", "三只松鼠", "农夫山泉",
        "奶茶", "奈雪", "蜜雪", "巧乐兹", "果汁", "麦片", "莓",
        "第三方", "东方甄选", "采销",
        # ----虚拟----
        "华为", "HUAWEI", "MiPay", "yzf", "翼支付",
        "火车", "电影", "门票", "打车", "单车", "流量", "出行优惠券", "网盘", "地铁", "网易云", "机票", "顺丰",
        # ----无效----
        "京东plus", "Plus拍下", "PLUS会员", "联通", "移动套餐", "美团圈圈", "王卡", "钻石会员",
        "元梦之星", "老乡鸡", "沪上阿姨", "永和大王",
    ]
