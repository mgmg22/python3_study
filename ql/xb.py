...
def filter_list(tr):
    ...
    blackList = [
        "【顶】",
        "定位", "部分", "山东", "福建", "江苏", "云南", "江西", "河北", "广州", "广东", "重庆",
        "首单", "盲盒", "需要邀请", "特邀", "助力", "前10", "点秒杀", "点试用", "以旧换新", "月黑风高", "生日礼",
        "多拍", "返红包", "券包", "直播间下单",
        "件", "/盒", "箱", "限量", "如有", "折合", "到手", "进口", "买家", "小法庭",
        # "返",
        "求", "啥", "咋", "呢", "请问", "问一下", "请教", "怎么", "怎样", "咨询", "居然要", "都多少",
        "吧？", "了？", "链接？", "么？", "呀!",
        "黄了", "没了", "果熟", "有果", "油果", "18cm", "续费", "拦截",
        "茅台", "京造", "京东买药", "巧乐兹", "第三方", "东方甄选", "馋嘴", "屈臣氏",
        "洗衣液", "內衣", "火锅", "拖鞋",
        "电影", "门票", "单车", "客服", "美元", "监控", "风险", "提额",
        "邮储联名", "邮储美团联名", "闪光卡", "广发", "联通", "华为", "MiPay", "中行xyk", "美团圈圈", "王卡",
        "元梦之星",
        "迅雷", "漏水", "洗发水", "纯水", "碱水", "流量",
    ]
