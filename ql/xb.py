...
def filter_list(tr):
    ...
    commonBlackList = [
        ...
        "广西", "辽宁",
        "厦门", "南京", "东莞", "广州", "南海", "苏州", "中山", "常州", "青岛", "成都", "武汉", "合肥", "揭阳",
        # ----卡----
        "平安X", "平安x", "平安银行X", "中行x", "民生x", "邮储x", "农行x", "交行x", "光大x", "阳光惠生活",
        "平安信", "平安银行信", "中行信", "中国银行信", "民生信", "邮储信", "农行信", "交行信", "光大信",
        "广发", "恒丰", "汇丰", "农商",
        "邮储联名", "邮储美团联名", "闪光卡", "浦大喜奔", "缤纷生活", "万事达",
        "宝石山", "众邦", "联名卡", "农行刷卡金",
    ]
    highBlackList = [
        "【顶】",
        ...
        "牛逼", "还好", "根本", "有点东西", "原因",
        "吗？", "吧？", "了？", "了?", "链接？", "么？", "呀!", "啊？", "啦 ！", "了啊", "用？",
        # ----负面----
        "黄了", "没了", "狗了", "差了", "删了", "不玩了", "领完了", "凉了",
        "果熟", "有果", "油果", "续费", "拦截", "黑号", "号黑", "限制使用",
        "被盗", "崩溃", "差评", "长期出", "监控", "套牢", "猫饼", "怀疑", "未到账", "过期", "凉凉",
        "不能卖", "垃圾", "逾期", "风控", "收腰", "彦祖", "奇怪", "我没有", "失败", "翻车",
        # ----虚拟----
        "风险", "美元", "提额", "保险", "开通", "境外", "秒批",
        "迅雷", "唯品会小程序", "爱奇艺红包", "电子书", "贷",
        # ----不符合预期的词语----
        "漏水", "纯水", "碱水", "水果", "水雾", "酒水", "吸水", "精萃水", "净水", "补水", "花露水", "热水",
        "玻璃水", "cm", "ml", "ML", "口水", "缩水", "水龙", "水润", "水牛", "水枪", "香水",
        "沥水", "水乳", "卸妆水", "防水",
        "签到红包",
    ]
    lowBlackList = [
        ...
        "小程序下单", "直播间下单",
        # ----居家----
        "內衣", "拖鞋", "洞洞鞋", "购物袋", "婴儿", "小孩", "无线",
        "杯", "椅", "清风", "纸",
        # ----食品----
        "火锅", "羊肉", "虾", "烧烤", "麻辣烫", "馋嘴", "卤", "粽子",
        "榴莲", "梨", "柠檬", "香菇", "鲜花", "椰子",
        "蛋白", "豆浆", "维生素",
        # ----个护----
        "洁面", "洗", "眉", "日抛",
