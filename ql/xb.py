...
def filter_list(tr):
    ...
    commonBlackList = [
        ...
        "济南", "大连",
        # ----卡----
        "平安X", "平安x", "平安银行X", "中行x", "民生x", "邮储x", "邮储X", "农行x", "交行x", "光大x", "阳光惠生活",
        "平安信", "平安银行信", "中行信", "中国银行信", "民生信", "邮储信", "农行信", "交行信", "光大信",
        "广发", "恒丰", "汇丰", "农商",
        "邮储联名", "邮储美团联名", "闪光卡", "浦大喜奔", "缤纷生活", "万事达",
        "宝石山", "众邦", "联名卡", "农行刷卡金", "北分", "交通银行数币",
        # ----无效----
        "特邀", "受邀", "瘦腰",
    ]
    highBlackList = [
        ...
        "有没有", "有问", "行不", "何解", "不行",
        "居然要", "都多少", "是多少", "是不是", "便宜啊", "麻烦", "帮忙看", "能不能", "哪来的", "卧槽", "不如不",
        "牛逼", "牛B", "还好", "根本", "有点东西", "原因", "感觉",
        "吗？", "吧？", "啥", "呢", "链接？", "么？", "呀!", "啊？", "啦 ！", "用？", "？？", "不？", "次？", "准？",
        "了？", "了?", "了。。", "了啊",
        # ----负面----
        "黄了", "没了", "狗了", "差了", "删了", "不玩了", "领完了", "凉了", "领不了", "不给退", "感谢", "卸载",
        "果熟", "有果", "油果", "续费", "拦截", "黑号", "号黑", "限制使用", "我才", "没抢到", "火爆", "销户",
        "被盗", "崩溃", "差评", "长期出", "监控", "套牢", "猫饼", "怀疑", "未到账", "过期", "凉凉", "心态", "无语",
        "不能卖", "垃圾", "逾期", "风控", "收腰", "彦祖", "奇怪", "我没有", "失败", "翻车", "退款", "发货", "毛线",
        "以后", "上限", "无耻", "想法", "抢不到", "网友",
        # ----虚拟----
        "风险", "美元", "提额", "保险", "开通", "境外", "秒批", "下卡", "送您一张会员礼品卡",
        "迅雷", "唯品会小程序", "爱奇艺红包", "电子书", "贷",
        # ----不符合预期的词语----
        "漏水", "纯水", "碱水", "水果", "水雾", "酒水", "吸水", "精萃水", "净水", "补水", "花露水", "热水",
        "玻璃水", "cm", "ml", "ML", "口水", "缩水", "水龙", "水润", "水牛", "水枪", "香水", "水壶",
        "沥水", "水乳", "卸妆水", "防水",
        "签到红包",
    ]
    lowBlackList = [
        ...
        "小程序下单", "直播间下单",
        # ----生活居家----
        "內衣", "拖鞋", "洞洞鞋", "购物袋", "婴儿", "小孩", "辣妈", "无线",
        "杯", "椅", "清风", "纸",
        # ----食品生鲜----
        "巧乐兹", "三只松鼠",
        "奶茶", "果汁", "奈雪", "蜜雪", "农夫山泉", "矿泉水", "茅台", "五粮液", "习酒", "窖", "特仑苏", "可生食",
        "火锅", "羊肉", "虾", "烧烤", "麻辣烫", "馋嘴", "卤", "炖", "粽子",
        "榴莲", "梨", "柠檬", "香菇", "鲜花", "椰子", "莓", "玫瑰", "酸菜",
        "蛋白", "豆浆", "维生素", "麦片",
        # ----美妆个护----
        "珀莱雅", "雅诗兰黛", "毛戈平", "屈臣氏",
        "洁面", "洗", "眉", "日抛", "护理", "采销", "立白",
